...
public class SuperCharacterController : MonoBehaviour
{
    ...
    public class SuperGround
    {
        ...
        public void ProbeGround(Vector3 origin, int iter)
        {
            ...
            {
                Debug.LogError("[SuperCharacterComponent]: No ground was found below the player; o ground was found below the player; Make sure the WALKABLE property in the SuperCharacter Controller component is set to the same layer as your level collision, and also that there is a TempCast layer in your project.");
            }
        }
